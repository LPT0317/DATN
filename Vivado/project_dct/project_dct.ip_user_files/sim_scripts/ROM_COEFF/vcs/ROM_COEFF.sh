...
#
# Script generated by Vivado on Wed Mar 20 14:53:23 +0700 2024
# SW Build 3900603 on Fri Jun 16 19:31:24 MDT 2023
#
# Tool Version Limit: 2023.06 
#
# Filename     : ROM_COEFF.sh
...
#
# Usage        : ROM_COEFF.sh
#                ROM_COEFF.sh [-lib_map_path] [-step] [-keep_index] [-noclean_files]*
#                ROM_COEFF.sh [-reset_run]
#                ROM_COEFF.sh [-reset_log]
#                ROM_COEFF.sh [-help]
#
...
#                script (type 'ROM_COEFF.sh -help' for more information).
#
...
# script info
echo -e "ROM_COEFF.sh - Script generated by export_simulation (Vivado v2023.1.1 (64-bit)-id)\n"
...
run()
{
  ...
  if [[ ($b_step == 1) ]]; then
    case $step in
      ...
      ;;
      * )
        echo -e "ERROR: Invalid or missing step '$step' (type \"./ROM_COEFF.sh -help\" for more information)\n"
        exit 1
      esac
  else
    init_lib
...
elaborate()
{
  vcs $vcs_elab_opts xil_defaultlib.ROM_COEFF xil_defaultlib.glbl -o ROM_COEFF_simv
}

# RUN_STEP: <simulate>
simulate()
{
  ./ROM_COEFF_simv $vcs_sim_opts -do simulate.do
}
...
reset_run()
{
  files_to_remove=(ucli.key ROM_COEFF_simv vlogan.log vhdlan.log compile.log elaborate.log simulate.log .tmp_log .vlogansetup.env .vlogansetup.args .vcs_lib_lock scirocco_command.log lib_sc.so 64 AN.DB csrc ROM_COEFF_simv.daidir vcs_lib c.obj)
...
check_arg_value()
{
  ...
  if [[ ($1 == "-lib_map_path") && ($2 == "") ]];then
    echo -e "ERROR: Simulation library directory path not specified (type \"./ROM_COEFF.sh -help\" for more information)\n"
    exit 1
  fi
}
...
usage()
{
  msg="Usage: ROM_COEFF.sh [-help]\n\
Usage: ROM_COEFF.sh [-step]\n\
Usage: ROM_COEFF.sh [-lib_map_path]\n\
Usage: ROM_COEFF.sh [-reset_run]\n\
Usage: ROM_COEFF.sh [-reset_log]\n\
Usage: ROM_COEFF.sh [-keep_index]\n\
Usage: ROM_COEFF.sh [-noclean_files]\n\n\
