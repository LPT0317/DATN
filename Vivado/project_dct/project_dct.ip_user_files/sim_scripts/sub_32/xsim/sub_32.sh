...
#
# Script generated by Vivado on Tue Mar 19 20:47:58 +0700 2024
...
#
# Usage        : sub_32.sh
#                sub_32.sh [-lib_map_path] [-step] [-keep_index] [-noclean_files]*
#                sub_32.sh [-reset_run]
#                sub_32.sh [-reset_log]
#                sub_32.sh [-help]
#
...
# script info
echo -e "sub_32.sh - Script generated by export_simulation (Vivado v2023.1.1 (64-bit)-id)\n"
...
run()
{
  ...
  if [[ ($b_step == 1) ]]; then
    case $step in
      ...
      ;;
      * )
        echo -e "ERROR: Invalid or missing step '$step' (type \"./sub_32.sh -help\" for more information)\n"
        exit 1
      esac
  else
    init_lib
...
reset_run()
{
  files_to_remove=(xelab.pb xsim.jou xvhdl.log xvlog.log compile.log elaborate.log simulate.log xelab.log xsim.log run.log xvhdl.pb xvlog.pb sub_32.wdb xsim.dir libdpi.so)
...
check_arg_value()
{
  ...
  if [[ ($1 == "-lib_map_path") && ($2 == "") ]];then
    echo -e "ERROR: Simulation library directory path not specified (type \"./sub_32.sh -help\" for more information)\n"
    exit 1
  fi
}
...
usage()
{
  msg="Usage: sub_32.sh [-help]\n\
Usage: sub_32.sh [-step]\n\
Usage: sub_32.sh [-lib_map_path]\n\
Usage: sub_32.sh [-reset_run]\n\
Usage: sub_32.sh [-reset_log]\n\
Usage: sub_32.sh [-keep_index]\n\
Usage: sub_32.sh [-noclean_files]\n\n\
