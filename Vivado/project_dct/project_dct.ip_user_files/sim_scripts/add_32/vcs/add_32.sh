...
#                script (type 'add_32.sh -help' for more information).
#
...
elaborate()
{
  vcs $vcs_elab_opts xil_defaultlib.add_32 xil_defaultlib.glbl -o add_32_simv
}

# RUN_STEP: <simulate>
simulate()
{
  ./add_32_simv $vcs_sim_opts -do simulate.do
}
...
reset_run()
{
  files_to_remove=(ucli.key add_32_simv vlogan.log vhdlan.log compile.log elaborate.log simulate.log .tmp_log .vlogansetup.env .vlogansetup.args .vcs_lib_lock scirocco_command.log lib_sc.so 64 AN.DB csrc add_32_simv.daidir vcs_lib c.obj)
