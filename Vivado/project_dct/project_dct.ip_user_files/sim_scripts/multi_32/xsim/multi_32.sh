...
#
# Script generated by Vivado on Wed Mar 20 10:58:00 +0700 2024
# SW Build 3900603 on Fri Jun 16 19:31:24 MDT 2023
#
# Tool Version Limit: 2023.06 
#
# Filename     : multi_32.sh
...
#
# Usage        : multi_32.sh
#                multi_32.sh [-lib_map_path] [-step] [-keep_index] [-noclean_files]*
#                multi_32.sh [-reset_run]
#                multi_32.sh [-reset_log]
#                multi_32.sh [-help]
#
...
# script info
echo -e "multi_32.sh - Script generated by export_simulation (Vivado v2023.1.1 (64-bit)-id)\n"
...
run()
{
  ...
  if [[ ($b_step == 1) ]]; then
    case $step in
      ...
      ;;
      * )
        echo -e "ERROR: Invalid or missing step '$step' (type \"./multi_32.sh -help\" for more information)\n"
        exit 1
      esac
  else
    init_lib
...
reset_run()
{
  files_to_remove=(xelab.pb xsim.jou xvhdl.log xvlog.log compile.log elaborate.log simulate.log xelab.log xsim.log run.log xvhdl.pb xvlog.pb multi_32.wdb xsim.dir libdpi.so)
...
check_arg_value()
{
  ...
  if [[ ($1 == "-lib_map_path") && ($2 == "") ]];then
    echo -e "ERROR: Simulation library directory path not specified (type \"./multi_32.sh -help\" for more information)\n"
    exit 1
  fi
}
...
usage()
{
  msg="Usage: multi_32.sh [-help]\n\
Usage: multi_32.sh [-step]\n\
Usage: multi_32.sh [-lib_map_path]\n\
Usage: multi_32.sh [-reset_run]\n\
Usage: multi_32.sh [-reset_log]\n\
Usage: multi_32.sh [-keep_index]\n\
Usage: multi_32.sh [-noclean_files]\n\n\
