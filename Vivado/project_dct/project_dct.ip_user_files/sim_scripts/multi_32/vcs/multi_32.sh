...
#                script (type 'multi_32.sh -help' for more information).
#
...
compile()
{
  ...
  vlogan -work floating_point_v7_1_15 $vlogan_opts +v2k +incdir+"C:/Xilinx/Vivado/2023.1/data/xilinx_vip/include" \
...
elaborate()
{
  vcs $vcs_elab_opts xil_defaultlib.multi_32 xil_defaultlib.glbl -o multi_32_simv
}

# RUN_STEP: <simulate>
simulate()
{
  ./multi_32_simv $vcs_sim_opts -do simulate.do
}
...
reset_run()
{
  files_to_remove=(ucli.key multi_32_simv vlogan.log vhdlan.log compile.log elaborate.log simulate.log .tmp_log .vlogansetup.env .vlogansetup.args .vcs_lib_lock scirocco_command.log lib_sc.so 64 AN.DB csrc multi_32_simv.daidir vcs_lib c.obj)
