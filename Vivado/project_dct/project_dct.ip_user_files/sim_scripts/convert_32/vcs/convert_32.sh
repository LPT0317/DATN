...
#
# Script generated by Vivado on Tue Mar 19 17:06:35 +0700 2024
# SW Build 3900603 on Fri Jun 16 19:31:24 MDT 2023
#
# Tool Version Limit: 2023.06 
#
# Filename     : convert_32.sh
...
#
# Usage        : convert_32.sh
#                convert_32.sh [-lib_map_path] [-step] [-keep_index] [-noclean_files]*
#                convert_32.sh [-reset_run]
#                convert_32.sh [-reset_log]
#                convert_32.sh [-help]
#
...
#                script (type 'convert_32.sh -help' for more information).
#
...
# script info
echo -e "convert_32.sh - Script generated by export_simulation (Vivado v2023.1.1 (64-bit)-id)\n"
...
run()
{
  ...
  if [[ ($b_step == 1) ]]; then
    case $step in
      ...
      ;;
      * )
        echo -e "ERROR: Invalid or missing step '$step' (type \"./convert_32.sh -help\" for more information)\n"
        exit 1
      esac
  else
    init_lib
...
elaborate()
{
  vcs $vcs_elab_opts xil_defaultlib.convert_32 xil_defaultlib.glbl -o convert_32_simv
}

# RUN_STEP: <simulate>
simulate()
{
  ./convert_32_simv $vcs_sim_opts -do simulate.do
}
...
reset_run()
{
  files_to_remove=(ucli.key convert_32_simv vlogan.log vhdlan.log compile.log elaborate.log simulate.log .tmp_log .vlogansetup.env .vlogansetup.args .vcs_lib_lock scirocco_command.log lib_sc.so 64 AN.DB csrc convert_32_simv.daidir vcs_lib c.obj)
...
check_arg_value()
{
  ...
  if [[ ($1 == "-lib_map_path") && ($2 == "") ]];then
    echo -e "ERROR: Simulation library directory path not specified (type \"./convert_32.sh -help\" for more information)\n"
    exit 1
  fi
}
...
usage()
{
  msg="Usage: convert_32.sh [-help]\n\
Usage: convert_32.sh [-step]\n\
Usage: convert_32.sh [-lib_map_path]\n\
Usage: convert_32.sh [-reset_run]\n\
Usage: convert_32.sh [-reset_log]\n\
Usage: convert_32.sh [-keep_index]\n\
Usage: convert_32.sh [-noclean_files]\n\n\
