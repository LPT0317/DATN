...
#
# Script generated by Vivado on Thu Mar 21 17:02:01 +0700 2024
...
#
# Usage        : RAM_DCT.sh
#                RAM_DCT.sh [-lib_map_path] [-step] [-keep_index] [-noclean_files]*
#                RAM_DCT.sh [-reset_run]
#                RAM_DCT.sh [-reset_log]
#                RAM_DCT.sh [-help]
#
...
#                script (type 'RAM_DCT.sh -help' for more information).
#
...
# script info
echo -e "RAM_DCT.sh - Script generated by export_simulation (Vivado v2023.1.1 (64-bit)-id)\n"
...
run()
{
  ...
  if [[ ($b_step == 1) ]]; then
    case $step in
      ...
      ;;
      * )
        echo -e "ERROR: Invalid or missing step '$step' (type \"./RAM_DCT.sh -help\" for more information)\n"
        exit 1
      esac
  else
    init_lib
...
elaborate()
{
  vcs $vcs_elab_opts xil_defaultlib.RAM_DCT xil_defaultlib.glbl -o RAM_DCT_simv
}

# RUN_STEP: <simulate>
simulate()
{
  ./RAM_DCT_simv $vcs_sim_opts -do simulate.do
}
...
reset_run()
{
  files_to_remove=(ucli.key RAM_DCT_simv vlogan.log vhdlan.log compile.log elaborate.log simulate.log .tmp_log .vlogansetup.env .vlogansetup.args .vcs_lib_lock scirocco_command.log lib_sc.so 64 AN.DB csrc RAM_DCT_simv.daidir vcs_lib c.obj)
...
check_arg_value()
{
  ...
  if [[ ($1 == "-lib_map_path") && ($2 == "") ]];then
    echo -e "ERROR: Simulation library directory path not specified (type \"./RAM_DCT.sh -help\" for more information)\n"
    exit 1
  fi
}
...
usage()
{
  msg="Usage: RAM_DCT.sh [-help]\n\
Usage: RAM_DCT.sh [-step]\n\
Usage: RAM_DCT.sh [-lib_map_path]\n\
Usage: RAM_DCT.sh [-reset_run]\n\
Usage: RAM_DCT.sh [-reset_log]\n\
Usage: RAM_DCT.sh [-keep_index]\n\
Usage: RAM_DCT.sh [-noclean_files]\n\n\
