...
HD_PWD='D:/CE/DAKTMT/Vivado/project_dct/project_dct.runs/convert_32_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log convert_32.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source convert_32.tcl
