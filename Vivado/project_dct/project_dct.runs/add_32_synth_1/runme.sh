...
HD_PWD='D:/CE/DAKTMT/Vivado/project_dct/project_dct.runs/add_32_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log add_32.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source add_32.tcl
