...
HD_PWD='D:/CE/DAKTMT/Vivado/project_dct/project_dct.runs/sub_32_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log sub_32.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source sub_32.tcl
