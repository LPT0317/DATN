...
HD_PWD='D:/CE/DAKTMT/Vivado/project_dct/project_dct.runs/ROM_COEFF_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log ROM_COEFF.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source ROM_COEFF.tcl
