...
HD_PWD='D:/CE/DAKTMT/Vivado/project_dct/project_dct.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log kria_top_wrapper.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source kria_top_wrapper.tcl -notrace
