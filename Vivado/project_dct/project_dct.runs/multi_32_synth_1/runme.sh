...
HD_PWD='D:/CE/DAKTMT/Vivado/project_dct/project_dct.runs/multi_32_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log multi_32.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source multi_32.tcl
