...
HD_PWD='D:/CE/DAKTMT/Vivado/project_dct/project_dct.runs/RAM_DCT_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log RAM_DCT.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source RAM_DCT.tcl
