...
HD_PWD='D:/CE/DAKTMT/Vivado/project_dct/project_dct.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log kria_top_wrapper.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source kria_top_wrapper.tcl
