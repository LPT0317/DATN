...
design_libs=(xbip_utils_v3_0_10 c_reg_fd_v12_0_6 xbip_dsp48_wrapper_v3_0_4 xbip_pipe_v3_0_6 xbip_dsp48_addsub_v3_0_6 xbip_addsub_v3_0_6 c_addsub_v12_0_15 xil_defaultlib)
...
elaborate()
{
  vcs $vcs_elab_opts xil_defaultlib.u_sub_32 -o u_sub_32_simv
}

# RUN_STEP: <simulate>
simulate()
{
  ./u_sub_32_simv $vcs_sim_opts -do simulate.do
}
...
reset_run()
{
  files_to_remove=(ucli.key u_sub_32_simv vlogan.log vhdlan.log compile.log elaborate.log simulate.log .tmp_log .vlogansetup.env .vlogansetup.args .vcs_lib_lock scirocco_command.log lib_sc.so 64 AN.DB csrc u_sub_32_simv.daidir vcs_lib c.obj)
