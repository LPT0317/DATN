...
#
# Script generated by Vivado on Wed Mar 20 22:36:57 +0700 2024
# SW Build 3900603 on Fri Jun 16 19:31:24 MDT 2023
#
# Tool Version Limit: 2023.06 
#
# Filename     : u_sub_32.sh
...
#
# Usage        : u_sub_32.sh
#                u_sub_32.sh [-lib_map_path] [-step] [-keep_index] [-noclean_files]*
#                u_sub_32.sh [-reset_run]
#                u_sub_32.sh [-reset_log]
#                u_sub_32.sh [-help]
#
...
#                script (type 'u_sub_32.sh -help' for more information).
#
...
design_libs_elab="-libname xbip_utils_v3_0_10 -libname c_reg_fd_v12_0_6 -libname xbip_dsp48_wrapper_v3_0_4 -libname xbip_pipe_v3_0_6 -libname xbip_dsp48_addsub_v3_0_6 -libname xbip_addsub_v3_0_6 -libname c_addsub_v12_0_15 -libname xil_defaultlib -libname secureip"

# set design libraries
design_libs=(simprims_ver xbip_utils_v3_0_10 c_reg_fd_v12_0_6 xbip_dsp48_wrapper_v3_0_4 xbip_pipe_v3_0_6 xbip_dsp48_addsub_v3_0_6 xbip_addsub_v3_0_6 c_addsub_v12_0_15 xil_defaultlib)

# simulation root library directory
sim_lib_dir="xcelium_lib"

# script info
echo -e "u_sub_32.sh - Script generated by export_simulation (Vivado v2023.1.1 (64-bit)-id)\n"
...
run()
{
  ...
  if [[ ($b_step == 1) ]]; then
    case $step in
      ...
      ;;
      * )
        echo -e "ERROR: Invalid or missing step '$step' (type \"./u_sub_32.sh -help\" for more information)\n"
        exit 1
      esac
  else
    init_lib
...
elaborate()
{
  xmelab $xmelab_opts $design_libs_elab xil_defaultlib.u_sub_32
}

# RUN_STEP: <simulate>
simulate()
{
  xmsim $xmsim_opts xil_defaultlib.u_sub_32 -input simulate.do
}
...
reset_run()
{
  files_to_remove=(xmvlog.log xmvhdl.log xmsc.log compile.log elaborate.log simulate.log diag_report.log xsc_report.log u_sub_32_sc.so .tmp_log xcelium_lib waves.shm c.obj)
...
check_arg_value()
{
  ...
  if [[ ($1 == "-lib_map_path") && ($2 == "") ]];then
    echo -e "ERROR: Simulation library directory path not specified (type \"./u_sub_32.sh -help\" for more information)\n"
    exit 1
  fi
}
...
usage()
{
  msg="Usage: u_sub_32.sh [-help]\n\
Usage: u_sub_32.sh [-step]\n\
Usage: u_sub_32.sh [-lib_map_path]\n\
Usage: u_sub_32.sh [-reset_run]\n\
Usage: u_sub_32.sh [-reset_log]\n\
Usage: u_sub_32.sh [-keep_index]\n\
Usage: u_sub_32.sh [-noclean_files]\n\n\
