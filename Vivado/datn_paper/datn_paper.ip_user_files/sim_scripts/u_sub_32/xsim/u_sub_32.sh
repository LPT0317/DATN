...
elaborate()
{
  xelab --incr --debug typical --relax --mt 2  -L xbip_utils_v3_0_10 -L c_reg_fd_v12_0_6 -L xbip_dsp48_wrapper_v3_0_4 -L xbip_pipe_v3_0_6 -L xbip_dsp48_addsub_v3_0_6 -L xbip_addsub_v3_0_6 -L c_addsub_v12_0_15 -L xil_defaultlib -L secureip -L xpm --snapshot u_sub_32 xil_defaultlib.u_sub_32 -log elaborate.log
}

# RUN_STEP: <simulate>
simulate()
{
  xsim u_sub_32 -key {Behavioral:sim_1:Functional:u_sub_32} -tclbatch cmd.tcl -log simulate.log
}
...
reset_run()
{
  files_to_remove=(xelab.pb xsim.jou xvhdl.log xvlog.log compile.log elaborate.log simulate.log xelab.log xsim.log run.log xvhdl.pb xvlog.pb u_sub_32.wdb xsim.dir libdpi.so)
