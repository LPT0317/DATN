...
#
# Script generated by Vivado on Wed Mar 20 22:42:47 +0700 2024
# SW Build 3900603 on Fri Jun 16 19:31:24 MDT 2023
#
# Tool Version Limit: 2023.06 
#
# Filename     : u_mult_32.sh
...
#
# Usage        : u_mult_32.sh
#                u_mult_32.sh [-lib_map_path] [-step] [-keep_index] [-noclean_files]*
#                u_mult_32.sh [-reset_run]
#                u_mult_32.sh [-reset_log]
#                u_mult_32.sh [-help]
#
...
# script info
echo -e "u_mult_32.sh - Script generated by export_simulation (Vivado v2023.1.1 (64-bit)-id)\n"
...
run()
{
  ...
  if [[ ($b_step == 1) ]]; then
    case $step in
      ...
      ;;
      * )
        echo -e "ERROR: Invalid or missing step '$step' (type \"./u_mult_32.sh -help\" for more information)\n"
        exit 1
      esac
  else
    init_lib
...
elaborate()
{
  xelab --incr --debug typical --relax --mt 2  -L xbip_utils_v3_0_10 -L xbip_pipe_v3_0_6 -L xbip_bram18k_v3_0_6 -L mult_gen_v12_0_18 -L xil_defaultlib -L secureip -L xpm --snapshot u_mult_32 xil_defaultlib.u_mult_32 -log elaborate.log
}

# RUN_STEP: <simulate>
simulate()
{
  xsim u_mult_32 -key {Behavioral:sim_1:Functional:u_mult_32} -tclbatch cmd.tcl -log simulate.log
}
...
reset_run()
{
  files_to_remove=(xelab.pb xsim.jou xvhdl.log xvlog.log compile.log elaborate.log simulate.log xelab.log xsim.log run.log xvhdl.pb xvlog.pb u_mult_32.wdb xsim.dir libdpi.so)
...
check_arg_value()
{
  ...
  if [[ ($1 == "-lib_map_path") && ($2 == "") ]];then
    echo -e "ERROR: Simulation library directory path not specified (type \"./u_mult_32.sh -help\" for more information)\n"
    exit 1
  fi
}
...
usage()
{
  msg="Usage: u_mult_32.sh [-help]\n\
Usage: u_mult_32.sh [-step]\n\
Usage: u_mult_32.sh [-lib_map_path]\n\
Usage: u_mult_32.sh [-reset_run]\n\
Usage: u_mult_32.sh [-reset_log]\n\
Usage: u_mult_32.sh [-keep_index]\n\
Usage: u_mult_32.sh [-noclean_files]\n\n\
