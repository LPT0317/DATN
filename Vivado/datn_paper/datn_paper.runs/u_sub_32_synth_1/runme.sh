...
HD_PWD='D:/CE/DAKTMT/Vivado/datn_paper/datn_paper.runs/u_sub_32_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log u_sub_32.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source u_sub_32.tcl
