...
HD_PWD='D:/CE/DAKTMT/Vivado/datn_paper/datn_paper.runs/u_add_32_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log u_add_32.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source u_add_32.tcl
