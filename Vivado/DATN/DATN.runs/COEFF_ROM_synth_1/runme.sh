...
HD_PWD='D:/CE/DAKTMT/Vivado/DATN/DATN.runs/COEFF_ROM_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log COEFF_ROM.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source COEFF_ROM.tcl
