...
HD_PWD='D:/CE/DAKTMT/Vivado/DATN/DATN.runs/TEST_DCT_RAM_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log TEST_DCT_RAM.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source TEST_DCT_RAM.tcl
