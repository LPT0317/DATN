...
HD_PWD='D:/CE/DAKTMT/Vivado/DATN/DATN.runs/TEST_BRAM_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log TEST_BRAM.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source TEST_BRAM.tcl
