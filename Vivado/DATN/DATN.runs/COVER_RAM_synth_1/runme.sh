...
HD_PWD='D:/CE/DAKTMT/Vivado/DATN/DATN.runs/COVER_RAM_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log COVER_RAM.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source COVER_RAM.tcl
