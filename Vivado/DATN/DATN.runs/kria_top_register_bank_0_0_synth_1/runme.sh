...
HD_PWD='D:/CE/DAKTMT/Vivado/DATN/DATN.runs/kria_top_register_bank_0_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log kria_top_register_bank_0_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source kria_top_register_bank_0_0.tcl
