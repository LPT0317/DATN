...
HD_PWD='D:/CE/DAKTMT/Vivado/DATN/DATN.runs/u_sub_16_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log u_sub_16.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source u_sub_16.tcl
