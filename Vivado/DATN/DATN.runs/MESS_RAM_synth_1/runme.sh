...
HD_PWD='D:/CE/DAKTMT/Vivado/DATN/DATN.runs/MESS_RAM_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log MESS_RAM.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source MESS_RAM.tcl
