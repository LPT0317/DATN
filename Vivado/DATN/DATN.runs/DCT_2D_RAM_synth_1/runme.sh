...
HD_PWD='D:/CE/DAKTMT/Vivado/DATN/DATN.runs/DCT_2D_RAM_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log DCT_2D_RAM.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source DCT_2D_RAM.tcl
