...
HD_PWD='D:/CE/DAKTMT/Vivado/DATN/DATN.runs/SECRET_TEST_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log SECRET_TEST.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source SECRET_TEST.tcl
