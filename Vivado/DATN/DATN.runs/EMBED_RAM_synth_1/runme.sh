...
HD_PWD='D:/CE/DAKTMT/Vivado/DATN/DATN.runs/EMBED_RAM_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log EMBED_RAM.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source EMBED_RAM.tcl
