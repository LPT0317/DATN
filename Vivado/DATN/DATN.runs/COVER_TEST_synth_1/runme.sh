...
HD_PWD='D:/CE/DAKTMT/Vivado/DATN/DATN.runs/COVER_TEST_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log COVER_TEST.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source COVER_TEST.tcl
