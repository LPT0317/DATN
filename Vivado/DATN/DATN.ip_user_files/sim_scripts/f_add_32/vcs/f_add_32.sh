...
#                script (type 'f_add_32.sh -help' for more information).
#
...
elaborate()
{
  vcs $vcs_elab_opts xil_defaultlib.f_add_32 xil_defaultlib.glbl -o f_add_32_simv
}

# RUN_STEP: <simulate>
simulate()
{
  ./f_add_32_simv $vcs_sim_opts -do simulate.do
}
...
reset_run()
{
  files_to_remove=(ucli.key f_add_32_simv vlogan.log vhdlan.log compile.log elaborate.log simulate.log .tmp_log .vlogansetup.env .vlogansetup.args .vcs_lib_lock scirocco_command.log lib_sc.so 64 AN.DB csrc f_add_32_simv.daidir vcs_lib c.obj)
