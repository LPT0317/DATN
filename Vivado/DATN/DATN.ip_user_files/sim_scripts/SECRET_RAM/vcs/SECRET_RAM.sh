...
#                script (type 'SECRET_RAM.sh -help' for more information).
#
...
elaborate()
{
  vcs $vcs_elab_opts xil_defaultlib.SECRET_RAM xil_defaultlib.glbl -o SECRET_RAM_simv
}

# RUN_STEP: <simulate>
simulate()
{
  ./SECRET_RAM_simv $vcs_sim_opts -do simulate.do
}
...
reset_run()
{
  files_to_remove=(ucli.key SECRET_RAM_simv vlogan.log vhdlan.log compile.log elaborate.log simulate.log .tmp_log .vlogansetup.env .vlogansetup.args .vcs_lib_lock scirocco_command.log lib_sc.so 64 AN.DB csrc SECRET_RAM_simv.daidir vcs_lib c.obj)
