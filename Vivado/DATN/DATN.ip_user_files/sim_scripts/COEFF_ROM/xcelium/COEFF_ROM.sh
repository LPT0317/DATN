...
elaborate()
{
  xmelab $xmelab_opts $design_libs_elab xil_defaultlib.COEFF_ROM xil_defaultlib.glbl
}

# RUN_STEP: <simulate>
simulate()
{
  xmsim $xmsim_opts xil_defaultlib.COEFF_ROM -input simulate.do
}
...
reset_run()
{
  files_to_remove=(xmvlog.log xmvhdl.log xmsc.log compile.log elaborate.log simulate.log diag_report.log xsc_report.log COEFF_ROM_sc.so .tmp_log xcelium_lib waves.shm c.obj)
