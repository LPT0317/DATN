...
#
# Script generated by Vivado on Sat Mar 30 23:33:09 +0700 2024
# SW Build 3900603 on Fri Jun 16 19:31:24 MDT 2023
#
# Tool Version Limit: 2023.06 
#
# Filename     : COEFF_ROM.sh
...
#
# Usage        : COEFF_ROM.sh
#                COEFF_ROM.sh [-lib_map_path] [-step] [-keep_index] [-noclean_files]*
#                COEFF_ROM.sh [-reset_run]
#                COEFF_ROM.sh [-reset_log]
#                COEFF_ROM.sh [-help]
#
...
# script info
echo -e "COEFF_ROM.sh - Script generated by export_simulation (Vivado v2023.1.1 (64-bit)-id)\n"
...
run()
{
  ...
  if [[ ($b_step == 1) ]]; then
    case $step in
      ...
      ;;
      * )
        echo -e "ERROR: Invalid or missing step '$step' (type \"./COEFF_ROM.sh -help\" for more information)\n"
        exit 1
      esac
  else
    init_lib
...
elaborate()
{
  xelab --incr --debug typical --relax --mt 2  -L blk_mem_gen_v8_4_6 -L xil_defaultlib -L xilinx_vip -L unisims_ver -L unimacro_ver -L secureip -L xpm --snapshot COEFF_ROM xil_defaultlib.COEFF_ROM xil_defaultlib.glbl -log elaborate.log
}

# RUN_STEP: <simulate>
simulate()
{
  xsim COEFF_ROM -key {Behavioral:sim_1:Functional:COEFF_ROM} -tclbatch cmd.tcl -protoinst "protoinst_files/kria_top.protoinst" -log simulate.log
}
...
reset_run()
{
  files_to_remove=(xelab.pb xsim.jou xvhdl.log xvlog.log compile.log elaborate.log simulate.log xelab.log xsim.log run.log xvhdl.pb xvlog.pb COEFF_ROM.wdb xsim.dir libdpi.so)
...
check_arg_value()
{
  ...
  if [[ ($1 == "-lib_map_path") && ($2 == "") ]];then
    echo -e "ERROR: Simulation library directory path not specified (type \"./COEFF_ROM.sh -help\" for more information)\n"
    exit 1
  fi
}
...
usage()
{
  msg="Usage: COEFF_ROM.sh [-help]\n\
Usage: COEFF_ROM.sh [-step]\n\
Usage: COEFF_ROM.sh [-lib_map_path]\n\
Usage: COEFF_ROM.sh [-reset_run]\n\
Usage: COEFF_ROM.sh [-reset_log]\n\
Usage: COEFF_ROM.sh [-keep_index]\n\
Usage: COEFF_ROM.sh [-noclean_files]\n\n\
