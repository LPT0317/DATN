...
#                script (type 'COEFF_ROM.sh -help' for more information).
#
...
elaborate()
{
  vcs $vcs_elab_opts xil_defaultlib.COEFF_ROM xil_defaultlib.glbl -o COEFF_ROM_simv
}

# RUN_STEP: <simulate>
simulate()
{
  ./COEFF_ROM_simv $vcs_sim_opts -do simulate.do
}
...
reset_run()
{
  files_to_remove=(ucli.key COEFF_ROM_simv vlogan.log vhdlan.log compile.log elaborate.log simulate.log .tmp_log .vlogansetup.env .vlogansetup.args .vcs_lib_lock scirocco_command.log lib_sc.so 64 AN.DB csrc COEFF_ROM_simv.daidir vcs_lib c.obj)
