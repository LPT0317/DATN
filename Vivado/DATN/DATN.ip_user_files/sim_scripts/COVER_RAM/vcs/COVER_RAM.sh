...
#
# Script generated by Vivado on Mon Apr 08 15:17:49 +0700 2024
# SW Build 3900603 on Fri Jun 16 19:31:24 MDT 2023
#
# Tool Version Limit: 2023.06 
#
# Filename     : COVER_RAM.sh
...
#
# Usage        : COVER_RAM.sh
#                COVER_RAM.sh [-lib_map_path] [-step] [-keep_index] [-noclean_files]*
#                COVER_RAM.sh [-reset_run]
#                COVER_RAM.sh [-reset_log]
#                COVER_RAM.sh [-help]
#
...
#                script (type 'COVER_RAM.sh -help' for more information).
#
...
# script info
echo -e "COVER_RAM.sh - Script generated by export_simulation (Vivado v2023.1.1 (64-bit)-id)\n"
...
run()
{
  ...
  if [[ ($b_step == 1) ]]; then
    case $step in
      ...
      ;;
      * )
        echo -e "ERROR: Invalid or missing step '$step' (type \"./COVER_RAM.sh -help\" for more information)\n"
        exit 1
      esac
  else
    init_lib
...
elaborate()
{
  vcs $vcs_elab_opts xil_defaultlib.COVER_RAM xil_defaultlib.glbl -o COVER_RAM_simv
}

# RUN_STEP: <simulate>
simulate()
{
  ./COVER_RAM_simv $vcs_sim_opts -do simulate.do
}
...
reset_run()
{
  files_to_remove=(ucli.key COVER_RAM_simv vlogan.log vhdlan.log compile.log elaborate.log simulate.log .tmp_log .vlogansetup.env .vlogansetup.args .vcs_lib_lock scirocco_command.log lib_sc.so 64 AN.DB csrc COVER_RAM_simv.daidir vcs_lib c.obj)
...
check_arg_value()
{
  ...
  if [[ ($1 == "-lib_map_path") && ($2 == "") ]];then
    echo -e "ERROR: Simulation library directory path not specified (type \"./COVER_RAM.sh -help\" for more information)\n"
    exit 1
  fi
}
...
usage()
{
  msg="Usage: COVER_RAM.sh [-help]\n\
Usage: COVER_RAM.sh [-step]\n\
Usage: COVER_RAM.sh [-lib_map_path]\n\
Usage: COVER_RAM.sh [-reset_run]\n\
Usage: COVER_RAM.sh [-reset_log]\n\
Usage: COVER_RAM.sh [-keep_index]\n\
Usage: COVER_RAM.sh [-noclean_files]\n\n\
