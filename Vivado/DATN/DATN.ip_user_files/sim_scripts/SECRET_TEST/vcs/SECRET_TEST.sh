...
#
# Script generated by Vivado on Fri Apr 26 01:21:01 +0700 2024
# SW Build 3900603 on Fri Jun 16 19:31:24 MDT 2023
#
# Tool Version Limit: 2023.06 
#
# Filename     : SECRET_TEST.sh
...
#
# Usage        : SECRET_TEST.sh
#                SECRET_TEST.sh [-lib_map_path] [-step] [-keep_index] [-noclean_files]*
#                SECRET_TEST.sh [-reset_run]
#                SECRET_TEST.sh [-reset_log]
#                SECRET_TEST.sh [-help]
#
...
#                script (type 'SECRET_TEST.sh -help' for more information).
#
...
# script info
echo -e "SECRET_TEST.sh - Script generated by export_simulation (Vivado v2023.1.1 (64-bit)-id)\n"
...
run()
{
  ...
  if [[ ($b_step == 1) ]]; then
    case $step in
      ...
      ;;
      * )
        echo -e "ERROR: Invalid or missing step '$step' (type \"./SECRET_TEST.sh -help\" for more information)\n"
        exit 1
      esac
  else
    init_lib
...
compile()
{
  ...
  vlogan -work blk_mem_gen_v8_4_6 $vlogan_opts +v2k +incdir+"C:/Xilinx/Vivado/2023.1/data/xilinx_vip/include" \
...
elaborate()
{
  vcs $vcs_elab_opts xil_defaultlib.SECRET_TEST xil_defaultlib.glbl -o SECRET_TEST_simv
}

# RUN_STEP: <simulate>
simulate()
{
  ./SECRET_TEST_simv $vcs_sim_opts -do simulate.do
}
...
reset_run()
{
  files_to_remove=(ucli.key SECRET_TEST_simv vlogan.log vhdlan.log compile.log elaborate.log simulate.log .tmp_log .vlogansetup.env .vlogansetup.args .vcs_lib_lock scirocco_command.log lib_sc.so 64 AN.DB csrc SECRET_TEST_simv.daidir vcs_lib c.obj)
...
check_arg_value()
{
  ...
  if [[ ($1 == "-lib_map_path") && ($2 == "") ]];then
    echo -e "ERROR: Simulation library directory path not specified (type \"./SECRET_TEST.sh -help\" for more information)\n"
    exit 1
  fi
}
...
usage()
{
  msg="Usage: SECRET_TEST.sh [-help]\n\
Usage: SECRET_TEST.sh [-step]\n\
Usage: SECRET_TEST.sh [-lib_map_path]\n\
Usage: SECRET_TEST.sh [-reset_run]\n\
Usage: SECRET_TEST.sh [-reset_log]\n\
Usage: SECRET_TEST.sh [-keep_index]\n\
Usage: SECRET_TEST.sh [-noclean_files]\n\n\
