...
#
# Script generated by Vivado on Tue Apr 30 21:14:07 +0700 2024
# SW Build 3900603 on Fri Jun 16 19:31:24 MDT 2023
#
# Tool Version Limit: 2023.06 
#
# Filename     : TEST_BRAM.sh
...
#
# Usage        : TEST_BRAM.sh
#                TEST_BRAM.sh [-lib_map_path] [-step] [-keep_index] [-noclean_files]*
#                TEST_BRAM.sh [-reset_run]
#                TEST_BRAM.sh [-reset_log]
#                TEST_BRAM.sh [-help]
#
...
#                script (type 'TEST_BRAM.sh -help' for more information).
#
...
# script info
echo -e "TEST_BRAM.sh - Script generated by export_simulation (Vivado v2023.1.1 (64-bit)-id)\n"
...
run()
{
  ...
  if [[ ($b_step == 1) ]]; then
    case $step in
      ...
      ;;
      * )
        echo -e "ERROR: Invalid or missing step '$step' (type \"./TEST_BRAM.sh -help\" for more information)\n"
        exit 1
      esac
  else
    init_lib
...
elaborate()
{
  vcs $vcs_elab_opts xil_defaultlib.TEST_BRAM xil_defaultlib.glbl -o TEST_BRAM_simv
}

# RUN_STEP: <simulate>
simulate()
{
  ./TEST_BRAM_simv $vcs_sim_opts -do simulate.do
}
...
reset_run()
{
  files_to_remove=(ucli.key TEST_BRAM_simv vlogan.log vhdlan.log compile.log elaborate.log simulate.log .tmp_log .vlogansetup.env .vlogansetup.args .vcs_lib_lock scirocco_command.log lib_sc.so 64 AN.DB csrc TEST_BRAM_simv.daidir vcs_lib c.obj)
...
check_arg_value()
{
  ...
  if [[ ($1 == "-lib_map_path") && ($2 == "") ]];then
    echo -e "ERROR: Simulation library directory path not specified (type \"./TEST_BRAM.sh -help\" for more information)\n"
    exit 1
  fi
}
...
usage()
{
  msg="Usage: TEST_BRAM.sh [-help]\n\
Usage: TEST_BRAM.sh [-step]\n\
Usage: TEST_BRAM.sh [-lib_map_path]\n\
Usage: TEST_BRAM.sh [-reset_run]\n\
Usage: TEST_BRAM.sh [-reset_log]\n\
Usage: TEST_BRAM.sh [-keep_index]\n\
Usage: TEST_BRAM.sh [-noclean_files]\n\n\
