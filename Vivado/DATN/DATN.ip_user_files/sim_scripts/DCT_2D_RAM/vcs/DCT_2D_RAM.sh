...
#
# Script generated by Vivado on Sat Mar 30 21:15:13 +0700 2024
# SW Build 3900603 on Fri Jun 16 19:31:24 MDT 2023
#
# Tool Version Limit: 2023.06 
#
# Filename     : DCT_2D_RAM.sh
...
#
# Usage        : DCT_2D_RAM.sh
#                DCT_2D_RAM.sh [-lib_map_path] [-step] [-keep_index] [-noclean_files]*
#                DCT_2D_RAM.sh [-reset_run]
#                DCT_2D_RAM.sh [-reset_log]
#                DCT_2D_RAM.sh [-help]
#
...
#                script (type 'DCT_2D_RAM.sh -help' for more information).
#
...
# script info
echo -e "DCT_2D_RAM.sh - Script generated by export_simulation (Vivado v2023.1.1 (64-bit)-id)\n"
...
run()
{
  ...
  if [[ ($b_step == 1) ]]; then
    case $step in
      ...
      ;;
      * )
        echo -e "ERROR: Invalid or missing step '$step' (type \"./DCT_2D_RAM.sh -help\" for more information)\n"
        exit 1
      esac
  else
    init_lib
...
elaborate()
{
  vcs $vcs_elab_opts xil_defaultlib.DCT_2D_RAM xil_defaultlib.glbl -o DCT_2D_RAM_simv
}

# RUN_STEP: <simulate>
simulate()
{
  ./DCT_2D_RAM_simv $vcs_sim_opts -do simulate.do
}
...
reset_run()
{
  files_to_remove=(ucli.key DCT_2D_RAM_simv vlogan.log vhdlan.log compile.log elaborate.log simulate.log .tmp_log .vlogansetup.env .vlogansetup.args .vcs_lib_lock scirocco_command.log lib_sc.so 64 AN.DB csrc DCT_2D_RAM_simv.daidir vcs_lib c.obj)
...
check_arg_value()
{
  ...
  if [[ ($1 == "-lib_map_path") && ($2 == "") ]];then
    echo -e "ERROR: Simulation library directory path not specified (type \"./DCT_2D_RAM.sh -help\" for more information)\n"
    exit 1
  fi
}
...
usage()
{
  msg="Usage: DCT_2D_RAM.sh [-help]\n\
Usage: DCT_2D_RAM.sh [-step]\n\
Usage: DCT_2D_RAM.sh [-lib_map_path]\n\
Usage: DCT_2D_RAM.sh [-reset_run]\n\
Usage: DCT_2D_RAM.sh [-reset_log]\n\
Usage: DCT_2D_RAM.sh [-keep_index]\n\
Usage: DCT_2D_RAM.sh [-noclean_files]\n\n\
