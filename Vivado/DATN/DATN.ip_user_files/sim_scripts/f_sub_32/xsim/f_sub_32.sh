...
#
# Script generated by Vivado on Wed May 15 06:42:02 +0700 2024
# SW Build 3900603 on Fri Jun 16 19:31:24 MDT 2023
#
# Tool Version Limit: 2023.06 
#
# Filename     : f_sub_32.sh
...
#
# Usage        : f_sub_32.sh
#                f_sub_32.sh [-lib_map_path] [-step] [-keep_index] [-noclean_files]*
#                f_sub_32.sh [-reset_run]
#                f_sub_32.sh [-reset_log]
#                f_sub_32.sh [-help]
#
...
# script info
echo -e "f_sub_32.sh - Script generated by export_simulation (Vivado v2023.1.1 (64-bit)-id)\n"
...
run()
{
  ...
  if [[ ($b_step == 1) ]]; then
    case $step in
      ...
      ;;
      * )
        echo -e "ERROR: Invalid or missing step '$step' (type \"./f_sub_32.sh -help\" for more information)\n"
        exit 1
      esac
  else
    init_lib
...
elaborate()
{
  xelab --incr --debug typical --relax --mt 2  -L xbip_utils_v3_0_10 -L axi_utils_v2_0_6 -L xbip_pipe_v3_0_6 -L xbip_dsp48_wrapper_v3_0_4 -L xbip_dsp48_addsub_v3_0_6 -L xbip_dsp48_multadd_v3_0_6 -L xbip_bram18k_v3_0_6 -L mult_gen_v12_0_18 -L floating_point_v7_1_15 -L xil_defaultlib -L xilinx_vip -L unisims_ver -L unimacro_ver -L secureip -L xpm --snapshot f_sub_32 xil_defaultlib.f_sub_32 xil_defaultlib.glbl -log elaborate.log
}

# RUN_STEP: <simulate>
simulate()
{
  xsim f_sub_32 -key {Behavioral:sim_1:Functional:f_sub_32} -tclbatch cmd.tcl -protoinst "protoinst_files/bd_3ec2.protoinst" -protoinst "protoinst_files/kria_top.protoinst" -log simulate.log
}
...
reset_run()
{
  files_to_remove=(xelab.pb xsim.jou xvhdl.log xvlog.log compile.log elaborate.log simulate.log xelab.log xsim.log run.log xvhdl.pb xvlog.pb f_sub_32.wdb xsim.dir libdpi.so)
...
check_arg_value()
{
  ...
  if [[ ($1 == "-lib_map_path") && ($2 == "") ]];then
    echo -e "ERROR: Simulation library directory path not specified (type \"./f_sub_32.sh -help\" for more information)\n"
    exit 1
  fi
}
...
usage()
{
  msg="Usage: f_sub_32.sh [-help]\n\
Usage: f_sub_32.sh [-step]\n\
Usage: f_sub_32.sh [-lib_map_path]\n\
Usage: f_sub_32.sh [-reset_run]\n\
Usage: f_sub_32.sh [-reset_log]\n\
Usage: f_sub_32.sh [-keep_index]\n\
Usage: f_sub_32.sh [-noclean_files]\n\n\
