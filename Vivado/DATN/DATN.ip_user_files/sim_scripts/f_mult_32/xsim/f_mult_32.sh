...
#
# Script generated by Vivado on Wed May 15 18:55:46 +0700 2024
# SW Build 3900603 on Fri Jun 16 19:31:24 MDT 2023
#
# Tool Version Limit: 2023.06 
#
# Filename     : f_mult_32.sh
...
#
# Usage        : f_mult_32.sh
#                f_mult_32.sh [-lib_map_path] [-step] [-keep_index] [-noclean_files]*
#                f_mult_32.sh [-reset_run]
#                f_mult_32.sh [-reset_log]
#                f_mult_32.sh [-help]
#
...
# script info
echo -e "f_mult_32.sh - Script generated by export_simulation (Vivado v2023.1.1 (64-bit)-id)\n"
...
run()
{
  ...
  if [[ ($b_step == 1) ]]; then
    case $step in
      ...
      ;;
      * )
        echo -e "ERROR: Invalid or missing step '$step' (type \"./f_mult_32.sh -help\" for more information)\n"
        exit 1
      esac
  else
    init_lib
...
reset_run()
{
  files_to_remove=(xelab.pb xsim.jou xvhdl.log xvlog.log compile.log elaborate.log simulate.log xelab.log xsim.log run.log xvhdl.pb xvlog.pb f_mult_32.wdb xsim.dir libdpi.so)
...
check_arg_value()
{
  ...
  if [[ ($1 == "-lib_map_path") && ($2 == "") ]];then
    echo -e "ERROR: Simulation library directory path not specified (type \"./f_mult_32.sh -help\" for more information)\n"
    exit 1
  fi
}
...
usage()
{
  msg="Usage: f_mult_32.sh [-help]\n\
Usage: f_mult_32.sh [-step]\n\
Usage: f_mult_32.sh [-lib_map_path]\n\
Usage: f_mult_32.sh [-reset_run]\n\
Usage: f_mult_32.sh [-reset_log]\n\
Usage: f_mult_32.sh [-keep_index]\n\
Usage: f_mult_32.sh [-noclean_files]\n\n\
