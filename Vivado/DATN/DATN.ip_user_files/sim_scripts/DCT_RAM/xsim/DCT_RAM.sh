...
#
# Script generated by Vivado on Wed Mar 27 18:55:30 +0700 2024
...
#
# Usage        : DCT_RAM.sh
#                DCT_RAM.sh [-lib_map_path] [-step] [-keep_index] [-noclean_files]*
#                DCT_RAM.sh [-reset_run]
#                DCT_RAM.sh [-reset_log]
#                DCT_RAM.sh [-help]
#
...
# script info
echo -e "DCT_RAM.sh - Script generated by export_simulation (Vivado v2023.1.1 (64-bit)-id)\n"
...
run()
{
  ...
  if [[ ($b_step == 1) ]]; then
    case $step in
      ...
      ;;
      * )
        echo -e "ERROR: Invalid or missing step '$step' (type \"./DCT_RAM.sh -help\" for more information)\n"
        exit 1
      esac
  else
    init_lib
...
elaborate()
{
  xelab --incr --debug typical --relax --mt 2  -L blk_mem_gen_v8_4_6 -L xil_defaultlib -L xilinx_vip -L unisims_ver -L unimacro_ver -L secureip -L xpm --snapshot DCT_RAM xil_defaultlib.DCT_RAM xil_defaultlib.glbl -log elaborate.log
}

# RUN_STEP: <simulate>
simulate()
{
  xsim DCT_RAM -key {Behavioral:sim_1:Functional:DCT_RAM} -tclbatch cmd.tcl -protoinst "protoinst_files/bd_3ec2.protoinst" -protoinst "protoinst_files/kria_top.protoinst" -log simulate.log
}
...
reset_run()
{
  files_to_remove=(xelab.pb xsim.jou xvhdl.log xvlog.log compile.log elaborate.log simulate.log xelab.log xsim.log run.log xvhdl.pb xvlog.pb DCT_RAM.wdb xsim.dir libdpi.so)
...
Usage: DCT_RAM.sh [-step]\n\
Usage: DCT_RAM.sh [-lib_map_path]\n\
Usage: DCT_RAM.sh [-reset_run]\n\
Usage: DCT_RAM.sh [-reset_log]\n\
Usage: DCT_RAM.sh [-keep_index]\n\
