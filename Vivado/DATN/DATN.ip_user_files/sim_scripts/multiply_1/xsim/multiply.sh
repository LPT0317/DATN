...
#
# Script generated by Vivado on Wed Mar 13 21:05:01 +0700 2024
...
# script info
echo -e "multiply.sh - Script generated by export_simulation (Vivado v2023.1.1 (64-bit)-id)\n"
...
elaborate()
{
  xelab --incr --debug typical --relax --mt 2  -L xbip_utils_v3_0_10 -L xbip_pipe_v3_0_6 -L xbip_bram18k_v3_0_6 -L mult_gen_v12_0_18 -L xil_defaultlib -L secureip -L xpm --snapshot multiply xil_defaultlib.multiply -log elaborate.log
}
