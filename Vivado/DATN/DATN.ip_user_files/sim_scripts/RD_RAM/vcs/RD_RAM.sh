...
#                script (type 'RD_RAM.sh -help' for more information).
#
...
elaborate()
{
  vcs $vcs_elab_opts xil_defaultlib.RD_RAM xil_defaultlib.glbl -o RD_RAM_simv
}

# RUN_STEP: <simulate>
simulate()
{
  ./RD_RAM_simv $vcs_sim_opts -do simulate.do
}
...
reset_run()
{
  files_to_remove=(ucli.key RD_RAM_simv vlogan.log vhdlan.log compile.log elaborate.log simulate.log .tmp_log .vlogansetup.env .vlogansetup.args .vcs_lib_lock scirocco_command.log lib_sc.so 64 AN.DB csrc RD_RAM_simv.daidir vcs_lib c.obj)
