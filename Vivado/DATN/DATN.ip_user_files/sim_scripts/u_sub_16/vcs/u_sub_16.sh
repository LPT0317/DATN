...
elaborate()
{
  vcs $vcs_elab_opts xil_defaultlib.u_sub_16 xil_defaultlib.glbl -o u_sub_16_simv
}

# RUN_STEP: <simulate>
simulate()
{
  ./u_sub_16_simv $vcs_sim_opts -do simulate.do
}
...
reset_run()
{
  files_to_remove=(ucli.key u_sub_16_simv vlogan.log vhdlan.log compile.log elaborate.log simulate.log .tmp_log .vlogansetup.env .vlogansetup.args .vcs_lib_lock scirocco_command.log lib_sc.so 64 AN.DB csrc u_sub_16_simv.daidir vcs_lib c.obj)
