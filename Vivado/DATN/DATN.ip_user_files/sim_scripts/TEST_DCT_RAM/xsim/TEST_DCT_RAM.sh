...
#
# Script generated by Vivado on Fri May 03 00:41:46 +0700 2024
# SW Build 3900603 on Fri Jun 16 19:31:24 MDT 2023
#
# Tool Version Limit: 2023.06 
#
# Filename     : TEST_DCT_RAM.sh
...
#
# Usage        : TEST_DCT_RAM.sh
#                TEST_DCT_RAM.sh [-lib_map_path] [-step] [-keep_index] [-noclean_files]*
#                TEST_DCT_RAM.sh [-reset_run]
#                TEST_DCT_RAM.sh [-reset_log]
#                TEST_DCT_RAM.sh [-help]
#
...
# script info
echo -e "TEST_DCT_RAM.sh - Script generated by export_simulation (Vivado v2023.1.1 (64-bit)-id)\n"
...
run()
{
  ...
  if [[ ($b_step == 1) ]]; then
    case $step in
      ...
      ;;
      * )
        echo -e "ERROR: Invalid or missing step '$step' (type \"./TEST_DCT_RAM.sh -help\" for more information)\n"
        exit 1
      esac
  else
    init_lib
...
elaborate()
{
  xelab --incr --debug typical --relax --mt 2  -L blk_mem_gen_v8_4_6 -L xil_defaultlib -L xilinx_vip -L unisims_ver -L unimacro_ver -L secureip -L xpm --snapshot TEST_DCT_RAM xil_defaultlib.TEST_DCT_RAM xil_defaultlib.glbl -log elaborate.log
}

# RUN_STEP: <simulate>
simulate()
{
  xsim TEST_DCT_RAM -key {Behavioral:sim_1:Functional:TEST_DCT_RAM} -tclbatch cmd.tcl -protoinst "protoinst_files/kria_top.protoinst" -log simulate.log
}
...
reset_run()
{
  files_to_remove=(xelab.pb xsim.jou xvhdl.log xvlog.log compile.log elaborate.log simulate.log xelab.log xsim.log run.log xvhdl.pb xvlog.pb TEST_DCT_RAM.wdb xsim.dir libdpi.so)
...
check_arg_value()
{
  ...
  if [[ ($1 == "-lib_map_path") && ($2 == "") ]];then
    echo -e "ERROR: Simulation library directory path not specified (type \"./TEST_DCT_RAM.sh -help\" for more information)\n"
    exit 1
  fi
}
...
usage()
{
  msg="Usage: TEST_DCT_RAM.sh [-help]\n\
Usage: TEST_DCT_RAM.sh [-step]\n\
Usage: TEST_DCT_RAM.sh [-lib_map_path]\n\
Usage: TEST_DCT_RAM.sh [-reset_run]\n\
Usage: TEST_DCT_RAM.sh [-reset_log]\n\
Usage: TEST_DCT_RAM.sh [-keep_index]\n\
Usage: TEST_DCT_RAM.sh [-noclean_files]\n\n\
