...
NUM_CHANNELS = 3
COVER_IMAGE_FILEPATH  = "./Airplane128.png" # Choose your cover image (PNG)
STEGO_IMAGE_FILEPATH  = "./stego_image.png"
SECRET_MESSAGE_STRING = "Lorem ipsum dolor sit amet, consectetur adipiscing elit. Integer facilisis, tellus at ma."
print(len(SECRET_MESSAGE_STRING))
# ============================================================================= #
# ============================================================================= #
